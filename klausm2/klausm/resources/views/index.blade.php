			...
			<div class="row">
				...
				<div class="col-sm-9 padding-right">
					<div class="features_items"><!--features_items-->
                        ...
                        <?php $ct = count($productsAll);echo $ct; for($i=0;$i<$ct;$i++) { ?> 
                        <?php if($i+1<$ct){if($productsAll[$i]['id'] == $productsAll[$i+1]['id'] ){ continue;} else { ?>
						<div class="col-sm-4">
							<div class="product-image-wrapper">
								<div class="single-products">
										<div class="productinfo text-center">
                                            <?php $tyn=""; foreach($productsAll[$i]['images'] as $ty){
                                              $tyn=$ty['image'];
                                             }?>
											<img src="{{ asset('/images/backend_images/products/medium/'.$tyn) }}" alt="" />
                                            <h2>NRs.{{ $productsAll[$i]->price}}</h2>
										...
										<div class="product-overlay">
											<div class="overlay-content">
												<h2>NRs.{{ $productsAll[$i]->price}}</h2>
												<p>{{ $productsAll[$i]->product_name}}</p>
                                                <a href="{{ url('/admin/product-details/'.$productsAll[$i]->id) }}" class="btn btn-default add-to-cart">View Details</a><br>
												<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
											</div>
										</div>
								</div>
